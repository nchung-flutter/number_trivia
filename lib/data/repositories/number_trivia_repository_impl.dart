...
class NumberTriviaRepositoryImpl implements NumberTriviaRepository {
  ...
  @override
  Future<Either<Failure, NumberTrivia>> getConcreteNumberTrivia(int number) async => await _getTrivia(() {
        return remoteDataSource.getConcreteNumberTrivia(number);
      });

  @override
  Future<Either<Failure, NumberTrivia>> getRandomNumberTrivia() async => await _getTrivia(() {
